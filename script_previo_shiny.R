...
drive_download("2.cv_reportes_llamadas_2021_2022.xlsx",overwrite = TRUE)
drive_download("1.cv_reportes_llamadas_2019_2020.xlsx",overwrite = TRUE)
...
reportes_llamadas_2021_2022 <- read_excel("2.cv_reportes_llamadas_2021_2022.xlsx")
reportes_llamadas_2019_2020 <- read_excel("1.cv_reportes_llamadas_2019_2020.xlsx")
...
mutate(clasificación=case_when(
  ...
  clasificación=="Violencia contra las mujeres"~ "Violencia contra las mujeres",
...
reportes_llamadas$municipio[reportes_llamadas$municipio=="Acatlán de Juaréz"] <- "Acatlán de Juárez"
reportes_llamadas$municipio[reportes_llamadas$municipio=="Ixtlahuacán del Rio"] <- "Ixtlahuacán del Río"
reportes_llamadas$municipio[reportes_llamadas$municipio=="Encarnacion de Díaz"] <- "Encarnación de Díaz"

reportes_llamadas$municipio[reportes_llamadas$municipio=="Jalostotitlan"] <- "Jalostotitlán"
reportes_llamadas$municipio[reportes_llamadas$municipio=="No Proporciona"] <- "No proporciona"
reportes_llamadas$municipio[reportes_llamadas$municipio=="Ocotlan"] <- "Ocotlán"
reportes_llamadas$municipio[reportes_llamadas$municipio=="Poncitlan"] <- "Poncitlán"
reportes_llamadas$municipio[reportes_llamadas$municipio=="San Cristóbal de La Barranca"] <- "San Cristóbal de la Barranca"
reportes_llamadas$municipio[reportes_llamadas$municipio=="San Julian"] <- "San Julián"
reportes_llamadas$municipio[reportes_llamadas$municipio=="San Martin Hidalgo"] <- "San Martín Hidalgo"
reportes_llamadas$municipio[reportes_llamadas$municipio=="Tecalitlan"] <- "Tecalitlán"
reportes_llamadas$municipio[reportes_llamadas$municipio=="TeColotlán"] <- "Tecolotlán"
reportes_llamadas$municipio[reportes_llamadas$municipio=="Tepatitlan de Morelos"] <- "Tepatitlán de Morelos"
reportes_llamadas$municipio[reportes_llamadas$municipio=="Tizapan el Alto"] <- "Tizapán el Alto"
reportes_llamadas$municipio[reportes_llamadas$municipio=="Toliman"] <- "Tolimán"
reportes_llamadas$municipio[reportes_llamadas$municipio=="Tomatlan"] <- "Tomatlán"
reportes_llamadas$municipio[reportes_llamadas$municipio=="Tototlan"] <- "Tototlán"
reportes_llamadas$municipio[reportes_llamadas$municipio=="Union de Tula"] <- "Unión de Tula"
reportes_llamadas$municipio[reportes_llamadas$municipio=="Union de San Antonio"] <- "Unión de San Antonio"

reportes_llamadas$municipio[reportes_llamadas$municipio=="Villa Purificacion"] <- "Villa Purificación"
reportes_llamadas$municipio[reportes_llamadas$municipio=="Yahualica de Gonzalez Gallo"] <- "Yahualica de González Gallo"
reportes_llamadas$municipio[reportes_llamadas$municipio=="Zapotitlan de Vadillo"] <- "Zapotitlán de Vadillo"
reportes_llamadas$municipio[reportes_llamadas$municipio=="Zapotlánejo"] <- "Zapotlanejo"
...
#Carpetas
Regiones<-read.csv("IDM_NM_sep23.csv", encoding="latin1", check.names = T) %>%
...
municipios_2<-read.csv("IDM_NM_sep23.csv",check.names = T, encoding = "latin1") %>%
  filter(Subtipo.de.delito %in% c("Abuso sexual", "Acoso sexual", "Hostigamiento sexual",
                                  "Violación simple", "Violación equiparada", "Feminicidio",
                                  "Violencia familiar",
                                  "Violencia de género en todas sus modalidades distinta a la violencia familiar"),
...
municipios_2<-municipios_2 %>%
  ...
  Estatal_total<-read.csv("IDM_NM_sep23.csv",check.names = T, encoding = "latin1") %>%   
  filter(Entidad=="Jalisco",
         Subtipo.de.delito %in% c("Abuso sexual", "Acoso sexual","Feminicidio", 
                                  "Hostigamiento sexual","Violación simple", "Violación equiparada", "Violencia familiar")) %>%
  mutate(Subtipo.de.delito=case_when(
    Subtipo.de.delito=="Acoso sexual"~"Acoso sexual",
    Subtipo.de.delito=="Abuso sexual"~"Abuso sexual",
    Subtipo.de.delito=="Violación equiparada"~"Violación",
...
victimas <- read.csv("IDVFC_NM_sep23.csv", encoding="latin1", check.names = T) %>%
